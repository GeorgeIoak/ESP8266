...
#define ADIS16203_TEMP_BIAS     (float)1278.0
#define ADIS16203_TEMP_SEN      (float)0.0025
#define ADIS16203_SUP_OUT_SF    (float)1.22
#define ADIS16203_ROAT_SEN      (float)0.025
